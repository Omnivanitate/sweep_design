...
class HeaderRelation(Protocol):
    ...
    def __radd__(
        self: R, other: Union['HeaderRelation', Num], **kwargs) -> R: ...
    ...
    @classmethod
    def correlate(cls: Type[R], r1: 'HeaderRelation',
                  r2: 'HeaderRelation', **kwargs) -> R: ...

    @classmethod
    def convolve(cls: Type[R], r1: 'HeaderRelation',
                 r2: 'HeaderRelation', **kwargs) -> R: ...
...
class HeaderSpectrum(HeaderRelation, Protocol):
    ...
    @classmethod
    def get_spectrum_from_amp_phase(cls: Type[SP], s1: HeaderRelation,
                                    s2: HeaderRelation, **kwargs) -> SP: ...
