...
from ..math_signals.math_uncalcsweep import (ApriorUncalculatedSweep,
                                             UncalculatedSweep)
from .header_signals.base_header import HeaderBase
from .header_signals.uncalcsweep_header import (NamedApriorUcalcSweep,
                                                NamedUncalcSweep)
...
class ComposedUncalcSweep:
    ...
    def __call__(self, time: Any = None, tht0 = 0., name: InName = None, category: str = None) ->  NamedSweep:
