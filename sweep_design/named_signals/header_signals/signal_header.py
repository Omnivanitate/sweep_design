...
class HeaderSpectrum(HeaderRelation):
    ...
    def get_signal(self, name: InName = None, 
                            category: str = None) -> 'HeaderSignal':
    ...
    def get_amp_spectrum(self, name: InName = None, 
                            category: str = None) -> 'HeaderSpectrum':
    ...
    def add_phase(self, other: HeaderBase, name: InName = None, 
                            category: str = None) -> 'HeaderSpectrum':
        name = make_name(name, dfn.make_default_add_phase_name, self, other)
        category = make_category(self, category)
        return HeaderSpectrum(name, category)
    
    def sub_phase(self, other: HeaderBase, name: InName = None,
                            category: str = None) -> 'HeaderSpectrum':
    ...
    @staticmethod
    def get_spectrum_from_amp_phase(amp: HeaderBase, phase: HeaderBase, 
            name:  InName = None, category = 'spectrum') -> 'HeaderSpectrum':
        name = make_name(name, 
...
class HeaderSignal(HeaderRelation):
    ...
    def get_spectrum(self, name: InName = None, 
                                category='spectrum') -> 'HeaderSpectrum':
        name = make_name(name, dfn.make_default_signal2spectrum_name, self)
        category = make_category(self, category)
        return HeaderSpectrum(name, category)
    
    def get_amlitude_spectrum(self, name: InName = None, 
                                category='amp_spectrum') -> 'HeaderSpectrum':
        name = make_name(name, dfn.make_default_spectrum_from_amp_name, self)
        category = make_category(self, category)
        return HeaderSpectrum(name, category)
        
    def get_phase_spectrum(self, name: InName = None, 
                                category='phase_spectrum') -> 'HeaderSpectrum':
