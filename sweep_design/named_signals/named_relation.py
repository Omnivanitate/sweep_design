...
class NamedRelation:
    ...
    @classmethod
    def _convert_input(cls: Type[CR], data: Any, name: InName = None) -> 'NamedRelation':
    ...
    def _operate(self: CR, other: Any, operation: MathOperation, 
    ...
    def equalize(cls: Type[CR], cr1: Any, cr2: Any, name1: InName = None, 
        ...
        header1, header2 = HeaderRelation.equalize(cr1.header, cr2.header, r1,
