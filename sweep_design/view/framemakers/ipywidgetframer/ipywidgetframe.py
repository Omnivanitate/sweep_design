...
from ...base_view.abc_common_framer_grapher.frame import (CommonCheckBox,
                                                           CommonCheckBoxFrame,
                                                           CommonController,
                                                           CommonDropdownFrame,
                                                           CommonFigureFrame,
...
class WidgetFrameMaker(CommonFrameMaker):
    ...
    @staticmethod
    def get_figure_frame(figure, 
                            frame_properties: Dict[str, Any]) -> 'FigureFrame':
    ...
    @staticmethod
    def get_checkbox_frame(frame_properties: Dict[str, Any], 
                            controller: CommonController) -> 'CheckBoxFrame':
    ...
    @staticmethod
    def get_dropdown_frame(dropdown_frame_properties: Dict[str, Any], 
                                            controller: CommonController) -> 'DropdownFrame':
        w = widgets.Dropdown(
...
class CheckBoxFrame(WidgetFrame, CommonCheckBoxFrame['CheckBox']):
    ...
    def add_choise(self, choise: str, groups: str, 
                    checkbox_properties: Dict[str, Any], 
                    controller: CommonController) -> None:
...
class DropdownFrame(WidgetFrame, CommonDropdownFrame[widgets.Dropdown]):
    ...
    def __init__(self, dropdown: widgets.Dropdown, no_data_name: str, 
                                        controller: CommonController) -> None:
...
class CheckBox(WidgetFrame, CommonCheckBox[widgets.Checkbox, CommonController]):
    ...
    def __init__(self, output: widgets.Checkbox, name: str, groups: Union[str, Set[str], None], controller: CommonController) -> None:
