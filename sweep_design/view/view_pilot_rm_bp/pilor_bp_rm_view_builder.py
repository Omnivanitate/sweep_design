...
class PilotRmBpViewBuilder:
    ...
    def __init__(
        ...
        self._main_sweep_frame = framer.get_figure_frame(main_sweep_figure, \
            properties_main_sweep_frame)
        ...
        checkbox_section = self._checkbox_signals_frame.h_add(self._checkbox_types_signals_frame)
    ...
    def add_choise_sweep(self, choise_name: str, group: str, 
                                    choise_properties: Dict[str, Any]) -> None: 

        self._checkbox_signals_frame.add_choise(
            choise_name, group, choise_properties, self._controller)

    def add_choise_type_signal(self, choise_name: str, group: str,
                                    choise_properties: Dict[str, Any]) -> None:
        self._checkbox_types_signals_frame.add_choise(
            choise_name, group, choise_properties, self._controller)
    
    def add_main_sweep_signals(self,
            time: np.ndarray,
    ...
    def add_line_spectrogram(self, 
        ...
        figure.add_line(time_spectrogram, frequency_spectrogram, line_name, group, line_properties)

    def add_image_spectrogram(self, 
            time: np.ndarray, 
            frequency: np.ndarray, 
