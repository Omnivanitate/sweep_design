...
class CommonFrameMaker(Generic[Figure, Controller], metaclass = ABCMeta):
    ...
    def get_figure_frame(figure: Figure, frame_properties: Dict[str, Any]) -> 'CommonFigureFrame[Figure]':
        pass

    @abstractstaticmethod
    def get_dropdown_frame(frame_properties: Dict[str, Any], controller: Controller) -> 'CommonDropdownFrame':
        pass

    @abstractstaticmethod
    def get_checkbox_frame(frame_properties: Dict[str, Any], controller: Controller) -> 'CommonCheckBoxFrame':
        pass
...
class CommonCheckBoxFrame(CommonFrame, Generic[Checkbox]):
    ...
    @abstractmethod
    def add_choise(self, choise: str, groups: Union[str, Iterable[str]], 
        checkbox_properties: Dict[str, Any], controller: Controller) -> None:
        pass
...
class CommonCheckBox(CommonFrame, Generic[Checkbox, Controller]):
    ...
    def __init__(self, checkbox: Checkbox , name: str, 
            groups: Union[str, Iterable[str]], controller: Controller) -> None:
...
class CommonDropdownFrame(CommonFrame, Generic[Dropbown]):
    ...
    def __init__(self, dropdown: Dropbown, no_data_name: str, controller: Controller = None) -> None:
